...
<?php
/*Prepared Statement*/
$sql = "SELECT tweets.id,users.username,tweets.content,tweets.timer FROM followers INNER JOIN tweets ON tweets.userid = followers.followee INNER JOIN block ON block.blocker != followers.followee INNER JOIN users ON users.id = tweets.userid WHERE followers.follower = " . $_SESSION["myID"];
...
<?php
/*Prepared Statement*/
$sql = "SELECT tweets.id,users.username,tweets.content,tweets.timer FROM tweets INNER JOIN block ON block.blocker != followers.followee INNER JOIN users ON tweets.userid=users.id ORDER BY tweets.timer DESC ";
